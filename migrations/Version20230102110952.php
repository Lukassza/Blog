 ...
 */
final class Version20230102110952 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE categorie ADD cate_to_user_id INT NOT NULL, CHANGE auteur user VARCHAR(25) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE categorie DROP cate_to_user_id, CHANGE user auteur VARCHAR(25) NOT NULL');
    }
}
